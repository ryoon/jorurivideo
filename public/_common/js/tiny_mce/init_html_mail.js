...
function initTinyMCE(originalSettings) {
  var settings = {
    ...
    // Theme options
    theme_advanced_buttons1: "fontsizeselect,separator,removeformat,separator,forecolor,backcolor,separator,bold,italic,underline,separator,justifyleft,justifycenter,justifyright,separator,bullist,numlist,separator,outdent,indent,blockquote,separator,code,cleanup",
