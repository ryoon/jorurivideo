...
class Sys::Admin::GroupChangeTemporariesController < Cms::Controller::Admin::Base
  ...
  def pre_dispatch
    ...
    @data_cls = Sys::Model::GroupChange::Temporal.cate_temp_class_name(params[:current])
    return error_auth unless @data_cls
...
protected
  ...
  def _settings_index
    #return Sys::Model::GroupChange::Temporal.categories
    return [Sys::Model::GroupChange::Temporal.cate_temp_class_object(params[:current])]
  end
