...
class Gw::Admin::Webmail::SysAddressesController < Gw::Controller::Admin::Base
  ...
  def index
    ...
    if params[:search]
      ...
      user.and "sys_users.ldap", 1 if Application.config(:show_only_ldap_user) == 1
  ...
  def show
    ...
    user.and :ldap, 1 if Application.config(:show_only_ldap_user) == 1
...
protected
  ...
  def ids_to_addrs(ids)
    ...
    item.and "sys_users.ldap", 1 if Application.config(:show_only_ldap_user) == 1
